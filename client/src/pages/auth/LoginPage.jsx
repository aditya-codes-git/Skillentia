            ...
            >
                ...
                <div className="text-center mb-10">
                    <motion.div
                        ...
                        className="mx-auto w-14 h-14 bg-gradient-to-br from-primary-500/20 to-indigo-500/20 rounded-2xl flex items-center justify-center mb-6 border border-primary-500/20 relative group overflow-hidden"
                    >
                        <div className="absolute inset-0 bg-primary-500/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
                        <Cpu className="w-7 h-7 text-primary-600 dark:text-primary-400 relative z-10" />
                    </motion.div>
                ...
                <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            id="email"
                            type="email"
                            className="w-full bg-white/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 transition-all outline-none"
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            type="password"
                            placeholder="••••••••"
                            className="w-full bg-white/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 transition-all outline-none tracking-widest"
                        />
                        {errors.password && (
                ...
                <div className="mt-8 relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase tracking-widest font-semibold">
                        <span className="px-4 bg-white dark:bg-[#0f1524] text-slate-400 rounded-full">Automated Login</span>
                    </div>
                </div>
